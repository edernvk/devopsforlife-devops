...
/**
 * Class FakerPicsumProvider
 * @author https://github.com/morawskim/faker-images
 * @since 2020-10-14 (local copy)
 *
 * Usage:
 *  $faker = Faker\Factory::create();
 *  $faker->addProvider(new \App\Helpers\FakerPicsumProvider($faker));
 *
 *  // size
 ...
 */
class FakerPicsumProvider extends BaseProvider
{
